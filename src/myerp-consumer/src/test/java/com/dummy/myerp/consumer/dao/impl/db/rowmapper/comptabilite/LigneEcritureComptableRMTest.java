...
public class LigneEcritureComptableRMTest {
    ...
    public void mapRow() {
        ...
        try {
            ...
            Mockito.when(resultSet.getBigDecimal("credit")).thenReturn(BigDecimal.valueOf(12));
            Mockito.when(resultSet.getBigDecimal("debit")).thenReturn(BigDecimal.valueOf(12));
            Mockito.when(resultSet.getString("libelle")).thenReturn("titi");

            ligne = rm.mapRow(resultSet, 0);
